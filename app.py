...
from indicadores import bitcoin_calcula_indicadores

# Importa a biblioteca yfinance para baixar os dados de cotação do Bitcoin
import yfinance as yf

# Define metadados para a documentação da API
tags_metadata = [{"name": "bitcoin", "description": "Prevendo o Preço de Bitcoin com Machine Learning"}]
...
app = FastAPI(title = "Bitcoin Price API",
              ...
              version = "1.0",
              contact = {"name": "Silmara", "e-mail": "silmarabasso@yahoo.com.br"},
...
async def predict(Features: Features):
    ...
    valor_historico_btc = bitcoin_calcula_indicadores(valor_historico_btc)
    ...
    scaler = load("scaler_bitcoin.bin")
